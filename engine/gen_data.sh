...
ENGINE_DD=../assets/dataScaffolding
GAME_DD=assets/dataScaffolding
STUB_D=stubs
OUT=data_scaffold.js
FINAL=../src/scenes
TTY=`tty`
AUTOFIX="0"
LIST="0"
    ...
    for scene in $scenes_dir/*.meta; do #scenes
      ...
      for room in $rooms_dir/*.meta; do #rooms
        ...
        for object in $objects_dir/*.meta; do #objects
          ...
          echo "tmp_object.view_overlay_animcycle_inst = gen_animcycle_inst(tmp_object.view_overlay_animcycle_id,tmp_level.animcycles);" >> $OUT
