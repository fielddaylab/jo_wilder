...
//{ command:FINALE_WILDCARD_COMMAND_NOTEBOOK, entry_fqid:"tunic.path.to.entry", prompt:stextToLines("I need to show them I know blah blah", cur_level.notifications_w), fail:[ "tunic.path.to.speak", "tunic.path.to.speak" ] },
