...
{ command:FINALE_WILDCARD_COMMAND_NOTEBOOK, entry_fqid:"tunic.path.to.entry", fail:[] },
];
...
//view
{
  ...
  self.draw = function(t)
  {
    ...
    if(self.cur_command.command == FINALE_WILDCARD_COMMAND_NOTEBOOK)
    {
      if(self.ui_state == UI_STATE_IN)     my_notebookview.draw(self.ui_state_p);
      if(self.ui_state == UI_STATE_SELECT) my_notebookview.draw(1);
      if(self.ui_state == UI_STATE_OUT)    my_notebookview.draw(1-self.ui_state_p);
    }
